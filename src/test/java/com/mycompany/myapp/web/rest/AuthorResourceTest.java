...
public class AuthorResourceTest {
    ...
    private static final DateTime DEFAULT_BIRTHDAY = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_BIRTHDAY = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBirthday().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_BIRTHDAY);
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBirthday().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_BIRTHDAY);
    }
